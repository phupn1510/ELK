...
/bin/sed -i 's/192.168.63.11/'$net'/g' nginx/default.conf
/bin/sed -i 's/192.168.63.11/'$net'/g' kibana/config/kibana.yml
...
/bin/sed -i 's/192.168.63.11/'$net'/g' input_template.sh
